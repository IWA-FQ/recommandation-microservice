package com.example.recommendationMicroservice.security.model;
...
public class User {
	...
	public User(Integer id, String email, String password, String firstname, String lastname, String city, Integer city_code, String work_field, String cv_link) {
		this.id = id;
